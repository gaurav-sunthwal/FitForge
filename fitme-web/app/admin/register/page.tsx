            ...
            <div className="w-full max-w-md">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-purple-200">First-time setup for FitForge Admin</p>
                    </div>
                    ...
                    {success ? (
                        ...
                        <form onSubmit={handleRegister} className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="secretKey" className="block text-sm font-medium text-purple-100 mb-2">
                                    Setup Secret Key
                                </label>
                                <input
                                    type="password"
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-purple-200 text-sm">
                            ...
                            <a href="/admin/login" className="text-pink-300 hover:text-pink-200 font-semibold">
                                Sign In
                            </a>
                        </p>
                    </div>
                ...
                <div className="mt-4 text-center text-purple-200 text-sm">
                    ...
                    <p className="mt-1 text-xs">Default setup key: setup-admin-2026</p>
                </div>
            </div>
        </div>
    );
